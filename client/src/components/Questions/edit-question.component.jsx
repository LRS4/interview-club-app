...
export default class EditQuestions extends Component {
    ...
    componentDidMount = () => {
        axios.get(`${process.env.REACT_APP_LOCAL_API_ENDPOINT}/questions/${this.props.match.params.id}`)
            .then(response => {
                this.setState({
        ...
        axios.get(`${process.env.REACT_APP_LOCAL_API_ENDPOINT}/users`)
            .then(response => {
    ...
    onSubmit = (e) => {
        ...
        axios.put(`${process.env.REACT_APP_LOCAL_API_ENDPOINT}/questions/update/` + this.props.match.params.id, question)
